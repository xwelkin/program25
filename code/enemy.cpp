...
int Enemy::attack(Life& target) {
    ...
    std::cout << name << " 使用技能 [" << skills[skillIndex].name << "] 对 " << target.name
              << " 造成了 " << damage << " 点伤害！" << std::endl;
    return damage;
}
